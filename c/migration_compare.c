/*
 * Project: Migration Model Validation
 * Author: Mark Rüegg
 * Date: 19-12-2025
 * Description: 
 * Compares predicted migration values against ground truth data.
 * Calculates statistical error metrics (MAE, MBE, MAPE) per country
 * and computing the Overall MAPE for the entire dataset.
 *
 * Usage: ./program truth.csv predictions.csv out.csv
 */
